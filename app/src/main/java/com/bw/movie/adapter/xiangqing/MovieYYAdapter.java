...
public class MovieYYAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<QycxBean.ResultBean>list;
    private Context context;

    public MovieYYAdapter(List<QycxBean.ResultBean> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = View.inflate(context, R.layout.movieyy_item, null);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            simpleDraweeView=itemView.findViewById(R.id.movieyy_logo);
            text_name=itemView.findViewById(R.id.movieyy_name);
            text_address=itemView.findViewById(R.id.movieyy_address);
            textViewZY = itemView.findViewById(R.id.movieyy_price);
