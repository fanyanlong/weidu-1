...
public class PriceYYAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<JgcxBean.ResultBean>list;
    private Context context;

    public PriceYYAdapter(List<JgcxBean.ResultBean> list, Context context) {
        this.list = list;
