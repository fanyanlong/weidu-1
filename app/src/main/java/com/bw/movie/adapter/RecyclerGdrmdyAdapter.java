...
public class RecyclerGdrmdyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private List<ShowingBean.ResultBean> list;
    private Context context;

    public RecyclerGdrmdyAdapter(List<ShowingBean.ResultBean> list, Context context) {
        this.list = list;
