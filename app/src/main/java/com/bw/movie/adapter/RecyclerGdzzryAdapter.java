...
public class RecyclerGdzzryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private List<HotBean.ResultBean> list;
    private Context context;

    public RecyclerGdzzryAdapter(List<HotBean.ResultBean> list, Context context) {
        this.list = list;
